...
public class MyMathTests {
    ...
    void myMathIntAbsTests() throws Exception {
        // "Tests Negative Input, 0 and Positive Input", 
    ...
    void myMathPowTests() throws Exception {
        // "Tests negative base, fractional base, 0 base, 0 exp, whole base and whole exponent", 
    ...
    void myMathPerfectSqrtTests() throws Exception {
        // "Tests Negative Values, 0, Positive Valid and Positive Invalid Numbers", 
